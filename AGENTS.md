...
## Environment
- This repo is developed on a fully capable macOS machine with Android SDK/emulators and Xcode installed.
- Do not disable Android builds; prefer running the full Android + iOS toolchains.
